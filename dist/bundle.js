...
/***/ function(module, exports, __webpack_require__) {
	...
	var _myApp = __webpack_require__(1);

	var temperatureDataUrl = 'https://raw.githubusercontent.com/FreeCodeCamp/ProjectReferenceData/master/global-temperature.json';
	...
	describe('Cows', function () {
	  ...
	  beforeEach(function () {
	    koe = Object.create(_myApp.cow);
	  });

	  it('should sound like a cow', function () {
	    expect(koe.sound()).to.equal('MOOOOOO');
	  });

	  it('should have 4 legs', function () {
	    expect(koe.legs).to.equal(4);
	  });
	});

	describe('Async tests', function () {
	  it('should retrieve base temperature asynchronously', function _callee() {
	    var prom, result;
	    return regeneratorRuntime.async(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            prom = Promise.resolve($.get(temperatureDataUrl));
	            _context.t0 = JSON;
	            _context.next = 4;
	            return regeneratorRuntime.awrap(prom);
